...
![Initial broad search across all indexes](01-initial-broad-search.png)
...
![All events from auth.log](03-authlog-all-events.png)
...
![SSH-specific events, 10 results](04-sshd-filtered-10events.png)
...
![SSH-specific events, 4 results](05-sshd-filtered-4events.png)
...
![SSH Brute Force Detection base query](06-brute-force-query-rex.png)
...
![Triggered Alerts page](08-triggered-alerts-page.png)
...
![Dashboard — failed login attempts and top source IPs](09-dashboard-failed-logins.png)
...
![Dashboard — successful logins and recent authentication events](10-dashboard-successful-logins.png)
