...
![Failed and accepted password events grouped by source IP](02-failed-accepted-stats-by-ip.png)
...
![Failed password count grouped by source IP](04-failed-password-count-by-ip.png)
...
![Failed password events from 10.0.2.2](05-failed-password-src-10-0-2-2.png)
...
![Failed password events from 192.168.56.102](06-failed-password-src-192-168-56-102.png)
...
![Full raw event list for 192.168.56.102](07-raw-session-events-192-168-56-102.png)
...
![Three failed password events from session 1757](01-failed-password-narrow-window.png)

![Same three failed password events with full detail](08-failed-password-3events-aug7.png)
...
![Failed attempts followed by a successful login](03-failed-accepted-events-30days.png)
...
![SSH negotiation failures generated by the nmap scan](09-nmap-unable-to-negotiate-events.png)
...
![Sudo events over the last 30 days](10-sudo-events-30days.png)
...
![Full auth.log source sorted by time, 907 events](11-full-authlog-907events.png)
